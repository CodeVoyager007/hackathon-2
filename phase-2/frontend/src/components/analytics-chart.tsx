...
const DEMO_TASKS: Partial<Task>[] = [
    { is_completed: true, updated_at: subDays(new Date(), 0).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 0).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 0).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 1).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 1).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 1).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 1).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 2).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 2).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 3).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 3).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 3).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 4).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 4).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 5).toISOString() },
    { is_completed: true, updated_at: subDays(new Date(), 6).toISOString() },
];
